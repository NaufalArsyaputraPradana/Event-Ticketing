...
<head>
    ...
    <style>
        ...
        .ticket { width: calc(200mm - 12mm); height: calc(80mm - 12mm); border-radius: 10px; border: 2px solid #0f172a; overflow: hidden; }
        .wrap { width: 100%; height: 100%; }
        .left, .right { float: left; height: 100%; }

        /* Tema */
        .left { width: 72%; background: #0b1220; color: #fff; padding: 10px 14px; box-sizing: border-box; position: relative; }
        .right { width: 28%; background: #ffffff; border-left: 2px dashed #d1d5db; text-align: center; box-sizing: border-box; padding: 8px; position: relative; }
        .brand { position: absolute; top: 8px; right: 12px; background: #f59e0b; color: #111827; font-size: 9px; font-weight: 800; padding: 3px 6px; border-radius: 9999px; }

        /* Judul & meta */
        .title { font-size: 18px; font-weight: 800; letter-spacing: .4px; margin: 0 0 6px; }
        .metas { margin-bottom: 8px; }
        ...
        .boxes { margin: 6px 0 10px; }
        .box { display: inline-block; min-width: 58px; padding: 6px 8px; margin-right: 6px; border: 2px solid #fbbf24; border-radius: 6px; text-align: center; }
        ...
        /* Info customer */
        .list { font-size: 10px; line-height: 1.45; }
        .list-row { margin-bottom: 2px; }
        .list b { color: #fbbf24; }

        /* QR Stub */
        .stub-title { font-size: 9px; color: #6b7280; text-transform: uppercase; letter-spacing: .6px; margin: 2px 0 6px; }
        .qr { width: 110px; height: 110px; margin: 0 auto 6px; border: 2px solid #e5e7eb; border-radius: 8px; }
    ...
    <div class="ticket">
        <div class="wrap clearfix">
            ...
            <div class="left">
                ...
                <div class="boxes">
                    <div class="box"><span class="box-label">Gate</span><span class="box-value">A3</span></div>
                    <div class="box"><span class="box-label">Row</span><span class="box-value">22</span></div>
                    <div class="box"><span class="box-label">Seat</span><span class="box-value">50</span></div>
                </div>
                <div class="list">
                    ...
                    <div class="list-row"><b>Status:</b> {{ ucfirst($ticket->status) }}</div>
                </div>
            </div>
